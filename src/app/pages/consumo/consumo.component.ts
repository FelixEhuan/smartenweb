...
export class ConsumoComponent  {
  ...
  data_barchart = [10.8, 11.4, 11.2, 10.3, 11.3, 10.8, 10.6, 11.2, 12.0, 11.7, 10.7, 11.2, 11.3, 11.1, 10.7, 11.1, 12.3, 11.6, 10.3, 0, 11.6, 12.1, 12.4, 13.3, 10.9, 11.0, 10.0, 10.5, 11.0, 0
  ];
    data_array = [];
    labels_array = [];
